...
import { $t, identity, middleware, remote, roles } from "../runtime";
import { modManagerService } from "../service/mod_manager_service";
import { checkSafeUrl } from "../utils/url";

export function createModManagerRouter() {
  ...
  const requestConcurrencyLimiter = middleware().requestConcurrencyLimiter;
